  ...
  return (
    <div className="space-y-10 animate-fade-in pb-20">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        >
          Bahagian Perancangan, Penyelidikan dan Data
        </motion.p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats2024.map((stat, index) => (
          ...
          >
            ...
            <p className="text-xs font-bold uppercase tracking-widest text-teal-200 mb-2">{stat.label}</p>
            <h3 className="text-5xl font-black text-[#FDE047] tracking-tighter">{stat.value}</h3>
            <div className="mt-4 flex items-center gap-2 text-[10px] font-bold text-teal-100/60 uppercase tracking-wider">
        ...
        <div className="space-y-8 max-w-4xl">
          ...
          {[
            ...
            <div key={field.id} className="flex flex-col md:flex-row md:items-center gap-4 md:gap-10 group">
              <label className="md:w-1/2 flex items-center gap-3 text-sm font-black text-gray-600 uppercase tracking-tight group-hover:text-teal-700 transition-colors">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-10 pt-4">
            <label className="md:w-1/2 flex flex-col gap-1 text-sm font-black text-gray-600 uppercase tracking-tight">
      ...
      <div className="text-center">
        <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Integriti Data Memacu Kecemerlangan Organisasi</p>
      </div>
    </div>
  );
};
